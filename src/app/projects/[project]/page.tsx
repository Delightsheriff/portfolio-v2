        ...
        <main className="max-w-6xl mx-auto lg:px-16 px-8">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-start justify-between flex-wrap mb-4">
              <h1 className="font-karla font-black tracking-tight sm:text-5xl text-3xl mb-4 max-w-md">
                {project.name}
              </h1>
              ...
              <div className="flex items-center gap-x-2">
                <a
                  ...
                  target="_blank"
                  className={`flex items-center gap-x-2 dark:bg-primary-bg bg-gray-100  dark:text-white text-gray-700 border border-transparent rounded-md px-4 py-2 duration-200 ${
                    !project.projectUrl
